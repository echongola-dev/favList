...
public class FavDB extends SQLiteOpenHelper {
    ...
    private static int DB_VERISON = 1;
    ...
    // Dont forget write spaces
    private static String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "(" + KEY_ID
            + " TEXT," + ITEM_TITLE+ " TEXT," + ITEM_IMAGE + " TEXT," + FAVORITE_STATUS+" TEXT)";
    public  FavDB (Context context)  {super(context,DATABASE_NAME, null,DB_VERISON);}
